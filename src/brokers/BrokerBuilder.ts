...
export abstract class BrokerBuilder<
	T extends AbstractBroker<TConfig>,
	TConfig
> {
	protected broker!: T;
	protected constructor(private cfg: IConfiguration) {}
	public withConfigResolver(
		configResolver: ConfigResolver<TConfig>
	): BrokerBuilder<T, TConfig> {
